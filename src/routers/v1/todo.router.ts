...
import { createTodo, getAllTodos, getTodoById, updateTodo } from '../../validators/application.validator';
...
appRouter.patch('/todo/:id', validateParams(getTodoById),validateRequestBody(updateTodo) , updateById);
